...
\begin{itemize}
\item[--] \emph{basic blocks} for register operations on symbolic transitions
\item[--] \emph{final blocks} for final register operations
\item[--] \emph{fallback blocks} for fallback register operations
\end{itemize}
\medskip
...
%\vspace{0.1em}
\captionof{figure}{
Artificial benchmarks (alternative group).
...
%\vspace{0.1em}
\captionof{figure}{
Artificial benchmarks (concatenation group).
...
%\vspace{0.1em}
\captionof{figure}{
Artificial benchmarks (repetition group).
}\label{fig:benchmark_dfa_aot_rep}
\medskip

\includegraphics[width=\linewidth]{img/benchmark_dfa_jit_main.pdf}
%\vspace{0.1em}
\captionof{figure}{
Artificial benchmarks (concatenation group).
...
\includegraphics[width=\linewidth]{img/benchmark_dfa_jit_iter.pdf}
%\vspace{0.1em}
\captionof{figure}{
Artificial benchmarks (repetition group).
